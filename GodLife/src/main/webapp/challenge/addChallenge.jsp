		...
		<!-- jQuery DatePicker -->
		 ...
		 $(function(){
			 $("button#addChallenge").on("click",function(){
				 alert("dd");
				 var title = $("input[name='challengeTitle']").val();
				 var joinPoint = $("input[name='joinPoint']").val();
				 var detail = $("textarea#detail").val();
				 var rule = $("textarea#rule").val();
				 var categ = $("input[name='challengeCategNo']").val();
				 var certiCycle = $("input[name='certiCycle']").val();
				  ...
				  <li class="list-group-item">
				    <form name="addChallengeForm" enctype="multipart/form-data">
						  ...
						  <div class="form-group">
						    ...
						    name="joinPoint" id="exampleInputPassword1" placeholder="최소단위 1000">
						  </div>
