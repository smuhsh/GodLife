				...
				<c:if test="${user.userEmail != null}">
	             ...
	             <li class="service_center_item">
					...
					<ul class="service_center_detail">
						...
						<li><a href="링크걸어주세요">포인트 구매</a></li>
						<li><a href="링크걸어주세요">쿠폰 구매</a></li>
						<li><a href="링크걸어주세요">상품권 구매</a></li>
						<li><a href="링크걸어주세요">기부하기</a></li>
		...
		<div class="menuDiv">
			...
			<ul class="menu">
				...
				<li class="new-product-category">
					<a	href="이벤트링크" style="text-decoration:none;">이벤트</a></li>
					
					<li class="new-product-category">
					<a	href="공지사항 링크" style="text-decoration:none;">공지사항</a></li>
					
					<li class="new-product-category">
					<a	href="자주하는 질문 링크" style="text-decoration:none;">FAQ</a></li>
