...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
   ...
   <script src="/javascript/bootstrap-dropdownhover.min.js"></script>
	...
	<script type="text/javascript">
	 ...
	 $(function(){
		 $("button#addOperatorNotice").on("click",function(){	
			...
			$("form[name='addOperatorNoticeForm']").attr("method", "POST").attr("action", "/operator/addOperatorNotice").submit();
			...
			<img src="/images/ct_ttl_img03.gif"	width="12" height="37"/>
				...
				<ul class="list-group">
				  <li class="list-group-item">
				    <form name="addOperatorNoticeForm" enctype="multipart/form-data">
	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="0">
			  ...
			  <div class="buttonGroup">
  			  		<button type="button" id="addOperatorNotice" class="btn btn-primary">등록</button>		  
