...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 13px;">
	...
	<tr>
		<td width="104" class="ct_write">
			작성자 <imgsrc="/images/ct_icon_red.gif" width="3" height="3" align="absmiddle">
		</td>
	...
	<tr>
		<td width="104" class="ct_write">
			상태 <img	src="/images/ct_icon_red.gif" width="3" height="3" align="absmiddle"/>
		</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
	...
	<tr>
		<td width="104" class="ct_write">
			필수사항 <img src="/images/ct_icon_red.gif" width="3" height="3" align="absmiddle"/>
		</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
	...
	<tr>
		<td width="104" class="ct_write">태그</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
